...
export async function generateMetadata(): Promise<Metadata> {
  const content = await loadSEOContent('out-of-business')
  ...
  return {
    ...
    openGraph: {
      ...
      images: [{
        ...
        width: 1200,
        height: 630,
        alt: 'Shark Tank Products That Failed'
      }],
      type: 'website'
    },
    twitter: {
    ...
    alternates: {
      canonical: `${SITE_URL}/out-of-business`
    }
  }
}

export default async function OutOfBusinessPage() {
  const [contentResult, productsResult, statsResult, sharkPhotosResult] = await Promise.allSettled([
    loadSEOContent('out-of-business'),
