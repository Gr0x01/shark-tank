...
const AmazonIcon = () => (
  <svg viewBox="0 0 35.418 35.418" fill="currentColor" className="w-5 h-5">
    ...
    <section className="mid-page-cta-section">
      <div className="max-w-3xl mx-auto px-6">
        <div className="cta-card">
          <div className="cta-card-badge">Where to Buy</div>
          <h3 className="cta-card-title">Ready to Buy {productName}?</h3>
          <p className="cta-card-text">
            Get the same product featured on Shark Tank
          ...
          {lastVerified && (
            <p className="cta-card-verified">
              Links verified {formatDate(lastVerified)}
            </p>
          )}
        </div>
      </div>
